...
if ( ! class_exists( 'WC_Class_DP_Discontinued_Product' ) ) {
	...
	class WC_Class_DP_Discontinued_Product {
		...
		public static function save( $post_id ) {
			...
			$is_discontinued = filter_input( INPUT_POST, 'is_customed_discontinued' ) !== null ? 'yes' : 'no';
			update_post_meta( $post_id, 'is_customed_discontinued', $is_discontinued );
