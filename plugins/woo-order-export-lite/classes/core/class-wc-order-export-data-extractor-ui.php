...
class WC_Order_Export_Data_Extractor_UI extends WC_Order_Export_Data_Extractor {
	...
	public static function get_order_fields_common() {
		return array(
			...
			'order_date'     => array( 'label' => __( 'Order Date', 'woo-order-export-lite' ), 'checked' => 1 ),
			'modified_date'  => array( 'label' => __( 'Modification Date', 'woo-order-export-lite' ), 'checked' => 0 ),
			'transaction_id' => array( 'label' => __( 'Transaction ID', 'woo-order-export-lite' ), 'checked' => 0 ),
			'completed_date' => array( 'label' => __( 'Completed Date', 'woo-order-export-lite' ), 'checked' => 0 ),
			'paid_date'      => array( 'label' => __( 'Paid Date', 'woo-order-export-lite' ), 'checked' => 0 ),
			'customer_note'  => array( 'label' => __( 'Customer Note', 'woo-order-export-lite' ), 'checked' => 1 ),
			'order_notes'    => array( 'label' => __( 'Order Notes', 'woo-order-export-lite' ), 'checked' => 0 ),
		);
	}
	...
	public static function get_order_fields_billing() {
		return array(
			...
			'billing_phone'        => array( 'label' => __( 'Phone (Billing)', 'woo-order-export-lite' ), 'checked' => 1 ),
		);
	}
