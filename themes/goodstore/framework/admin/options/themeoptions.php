...
$options[] = array(
    ...
    'type' => 'toggle',
    'name' => 'Show Featured Image on Pages',
    'desc' => 'Decide whether or not to show featured image on pages of the theme (assign featured image on page).',
    'std' => '0',
    "options" => array("1" => "On", "0" => "Off")
);
...
$options[] = array("name" => "Footer Text",
    ...
    "id" => "footer_text",
    "std" => 'Copyright &copy; 2017 Design by Jawtemplates.com. <a href="https://www.wordpress-themes.market/12-handpicked-the-best-wordpress-responsive-themes-2017-with-page-builder/">In Best Theme Collection 2017</a>',
    "type" => "textarea");
