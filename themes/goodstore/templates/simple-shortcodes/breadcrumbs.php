...
if (isset($options['breadcrumbs-enable']) && $options['breadcrumbs-enable'] === true) {
    ...
    if (is_tag()) {
        ...
        if (is_product_category()) {
            ...
            echo '<a href="' . get_the_permalink(wc_get_page_id('shop')) . '">' . __('Shop', 'jawtemplates') . '</a>';
        } else {
        ...
        if (function_exists('wc_get_page_id') && wc_get_page_id('shop') > 0 && !is_shop() && jwOpt::get_option('woo_breadcrumbs_show_shop', '0') == '1') {
            echo '<a href="' . get_the_permalink(wc_get_page_id('shop')) . '">' . __('Shop', 'jawtemplates') . '</a>';
        }
        ...
        echo '<a href="#">' . __('Search', 'woocommerce') . ' ' . get_search_query() . '</a>';
