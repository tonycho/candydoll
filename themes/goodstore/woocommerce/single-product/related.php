...
if (function_exists('is_product') && is_product()) {
    //$related = $product->get_related(jwOpt::get_option('woo_number_related_produts', 5)); woo < v3 deprecated
    $related = wc_get_related_products(get_the_ID(),jwOpt::get_option('woo_number_related_produts', 5));
